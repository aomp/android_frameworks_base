...
final class DisplayPowerController {
    ...
    private static final int ELECTRON_BEAM_ON_ANIMATION_DURATION_MILLIS = 20;// 250;
    private static final int ELECTRON_BEAM_OFF_ANIMATION_DURATION_MILLIS = 20;// 400;
    ...
    private static final int LIGHT_SENSOR_RATE_MILLIS = 10;    /// MTK: Auto backlight
    ...
    private static final int BRIGHTNESS_RAMP_RATE_FAST = 40;
    ...
    private static final long LONG_TERM_AVERAGE_LIGHT_TIME_CONSTANT = 100;  /// MTK: Auto backlight
    ...
    private static final long BRIGHTENING_LIGHT_DEBOUNCE = 30; /// MTK: Auto backlight
    private static final long DARKENING_LIGHT_DEBOUNCE = 30;   /// MTK: Auto backlight
