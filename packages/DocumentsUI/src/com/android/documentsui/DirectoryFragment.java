...
public class DirectoryFragment extends Fragment {
    ...
    /// M: add to support drm, create OmaDrmClient to check right and show lock icon.
    ...
    private class DocumentsAdapter extends BaseAdapter {
        ...
        private View getDocumentView(int position, View convertView, ViewGroup parent) {
            ...
            if (DocumentsFeatureOption.IS_SUPPORT_DRM && isDrm
                ...
                if (data != null) {
                    right = mOmaDrmClient.checkRightsStatus(data, actionId);
                }
    ...
    /// M: add to support drm, create OmaDrmClient in onCreate and release it in onDestory. {@
    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        if (DocumentsFeatureOption.IS_SUPPORT_DRM) {
            mOmaDrmClient = new OmaDrmClient(getActivity());
        }
    }

    @Override
    public void onDestroy() {
        if (DocumentsFeatureOption.IS_SUPPORT_DRM && mOmaDrmClient != null) {
            mOmaDrmClient.release();
        }
        super.onDestroy();
    }
    /// @}
