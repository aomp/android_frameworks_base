...
public class SQLiteCursor extends AbstractWindowedCursor {
    ...
    /// M: Cursor leak warning debug
    private static final boolean DEBUG_CURSOR_LEAK_WARNING = Log.isLoggable("Cursor_Leak_Warning", Log.VERBOSE);
        ...
        try {
            ...
            if (mWindow != null) {
                if (mStackTrace != null) {
                    ...
                    if (DEBUG_CURSOR_LEAK_WARNING && checkAeeWarningList()) {
                        try {
