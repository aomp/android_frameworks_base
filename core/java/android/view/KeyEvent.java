...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    */
    ...
    public static final int KEYCODE_FCOVER_1        = 229;  

    public static final int KEYCODE_FCOVER_2        = 230;
    

    private static final int LAST_KEYCODE           = KEYCODE_FCOVER_2;
    ...
    private static void populateKeycodeSymbolicNames() {
        ...
        names.append(KEYCODE_FCOVER_1, "KEYCODE_FCOVER_1");            
        names.append(KEYCODE_FCOVER_2, "KEYCODE_FCOVER_2");           
    };
