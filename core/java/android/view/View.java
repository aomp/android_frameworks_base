   ...
   /**
    ...
    public void layout(int l, int t, int r, int b) {
        ...
        if ((mPrivateFlags3 & PFLAG3_MEASURE_NEEDED_BEFORE_LAYOUT) != 0) {
            ...
            if (DBG_LAYOUT) {
            Xlog.d(VIEW_LOG_TAG, "veiw onMeasure start (measure cache), this =" + this + ", widthMeasureSpec = " +
                MeasureSpec.toString(mOldWidthMeasureSpec) + ", heightMeasureSpec = " + MeasureSpec.toString(mOldHeightMeasureSpec));
            }
            long logTime = System.currentTimeMillis();
            ...
            if (DBG_LAYOUT) {
                Xlog.d(VIEW_LOG_TAG, "veiw onMeasure end (measure cache), this =" + this + ", mMeasuredWidth = "
        ...
        if (changed || (mPrivateFlags & PFLAG_LAYOUT_REQUIRED) == PFLAG_LAYOUT_REQUIRED) {
            ...
            long nowTime = System.currentTimeMillis();
            if (nowTime - logTime > DBG_TIMEOUT_VALUE) {
                Xlog.d(VIEW_LOG_TAG, "[ANR Warning]onLayout time too long, this =" + this + "time =" + (nowTime - logTime) + " ms");
            }
            if (DBG_LAYOUT) {
    ...
    public final void measure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if ((mPrivateFlags & PFLAG_FORCE_LAYOUT) == PFLAG_FORCE_LAYOUT ||
            ...
            if (cacheIndex < 0 || sIgnoreMeasureCache) {
                ...
                mPrivateFlags3 |= PFLAG3_MEASURE_NEEDED_BEFORE_LAYOUT;
                if (DBG_LAYOUT) {
                    Xlog.d(VIEW_LOG_TAG, "veiw measure end 2 use measure chache, this =" + this + ", mMeasuredWidth = "
