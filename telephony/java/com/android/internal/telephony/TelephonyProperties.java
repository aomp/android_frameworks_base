...
public interface TelephonyProperties
{
    ...
    */
    ...
    static final String PROPERTY_NITZ_OPER_CODE4 = "persist.radio.nitz_oper_code4";
    ...
    //MTK-START For LTE
    static final String PROPERTY_OPERATOR_ALPHA_LTEDC = "gsm.operator.alpha.ltedc";
    static final String PROPERTY_OPERATOR_NUMERIC_LTEDC = "gsm.operator.numeric.ltedc";
    static final String PROPERTY_OPERATOR_ISROAMING_LTEDC = "gsm.operator.isroaming.ltedc";
    static final String PROPERTY_OPERATOR_ISO_COUNTRY_LTEDC = "gsm.operator.iso-country.ltedc";
    static String PROPERTY_DATA_NETWORK_TYPE_LTEDC = "gsm.network.type.ltedc";
    static final String PROPERTY_CS_NETWORK_TYPE_LTEDC = "gsm.cs.network.type.ltedc";
    static final String PROPERTY_ROAMING_INDICATOR_NEEDED_LTEDC = "gsm.roaming.indicator.ltedc";
    //MTK-END For LTE
    /**
    * World Phone Modem Type
    */
